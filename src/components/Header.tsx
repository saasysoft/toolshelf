        ...
        <nav className="ml-auto flex items-center gap-1">
          ...
          {!loading && (
            user ? (
              ...
              <Link
                href="/login"
                className="ml-1 rounded-lg px-3 py-2 text-sm font-medium text-zinc-600 transition-colors hover:bg-zinc-100 hover:text-zinc-900 dark:text-zinc-400 dark:hover:bg-zinc-800 dark:hover:text-zinc-100"
              >
                Sign In
              </Link>
            )
